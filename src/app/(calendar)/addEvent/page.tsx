...
//             const eventData = {
//                 ...formData,
//                 start: { dateTime: formData.start, timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone },
//                 end: { dateTime: formData.end, timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone },
//                 attendees,
//             };
...
//                         <div>
//                             <label className="block text-gray-700 mb-2" htmlFor="start">
//                                 Start Date & Time
//                             </label>
//                             <input
//                                 type="datetime-local"
...
//                         </div>
//                         <div>
//                             <label className="block text-gray-700 mb-2" htmlFor="end">
//                                 End Date & Time
//                             </label>
//                             <input
//                                 type="datetime-local"
...
import { createNewEvent } from '../../axiosPath/events';
import { formatDateToGoogleCalendar } from '@/lib/dateFormat';
